...
$members = $payment->getUnpaidByYearAndType($year, 'adhesion');
...
<head>
    <meta charset="UTF-8">
    <title>غير المنخرطين - <?= $year ?></title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .report-header { text-align: center; margin-bottom: 25px; border-bottom: 3px solid #e67e22; padding-bottom: 15px; }
        .report-header h2 { color: #203a85; font-size: 22px; margin-bottom: 6px; }
        .report-header h3 { color: #e67e22; font-size: 16px; font-weight: bold; }
        ...
        tbody tr:nth-child(even) { background-color: #fef9f0; }
        tfoot td { background-color: #e67e22; color: white; font-weight: bold; }
...
<body>
    ...
    <div class="report-header">
        ...
        <h3>قائمة غير المنخرطين سنوياً - <?= $year ?></h3>
    </div>

    <div class="report-meta">
        <span>عدد غير المنخرطين: <strong><?= count($members) ?></strong></span>
    ...
    <table>
        ...
        <tfoot>
            <tr><td colspan="6">المجموع: <?= count($members) ?> مشترك لم ينخرط سنوياً</td></tr>
        </tfoot>
    </table>
    <?php else: ?>
    <p class="empty">✓ جميع المشتركين أدوا الانخراط السنوي</p>
    <?php endif; ?>
</body>
</html>