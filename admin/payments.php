...
<div class="absences p-20 bg-fff rad-10 m-20">
    ...
    <div class="section-header">
        ...
        <div class="export-btns">
            <a href="/sport-club/admin/unpaid_month.php" class="btn-shape color-fff" style="background:#b45309;">
                <i class="fas fa-exclamation-circle"></i> غير المدفوعين
            </a>
            <a href="/sport-club/admin/black_list.php" class="btn-shape color-fff" style="background:#b91c1c;">
