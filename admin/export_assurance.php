...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .report-header { text-align: center; margin-bottom: 25px; border-bottom: 3px solid #8e44ad; padding-bottom: 15px; }
        .report-header h2 { color: #203a85; font-size: 22px; margin-bottom: 6px; }
        .report-header h3 { color: #8e44ad; font-size: 16px; font-weight: bold; }
        ...
        tfoot td { background-color: #8e44ad; color: white; font-weight: bold; }
